...
public class RolColSum {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        System.out.println(getTask(array3, 0).get());
        System.out.println(Arrays.toString(asyncSum(array5)));
        System.out.println(Arrays.toString(sum(array5)));
    }
}
